    ...
    <div class="mx-auto max-w-4xl px-3 sm:px-4 py-6 sm:py-8">
      <div class="mb-4 sm:mb-6">
        ...
        >
          ...
          {{ $t('customerOrderTrackingPage.backToOrders') }}
        </button>
        <h1 class="text-xl sm:text-2xl font-bold text-slate-900">{{ $t('customerOrderTrackingPage.title') }}</h1>
        <p class="mt-2 text-xs sm:text-sm text-slate-600">{{ $t('customerOrderTrackingPage.orderIdLabel') }}{{ orderId }}</p>
      </div>

      <div v-if="order" class="space-y-6">
        <!-- Order Status Timeline -->
        <div class="bg-white rounded-lg border border-slate-200 p-6">
          <h2 class="text-lg font-semibold text-slate-900 mb-4">{{ $t('customerOrderTrackingPage.orderStatus') }}</h2>
          <div class="relative">
        ...
        <div class="bg-white rounded-lg border border-slate-200 p-6">
          <h2 class="text-lg font-semibold text-slate-900 mb-4">{{ $t('customerOrderTrackingPage.deliveryInfo') }}</h2>
          <div class="grid gap-4 sm:grid-cols-2">
            <div>
              <p class="text-sm font-medium text-slate-600 mb-1">{{ $t('customerOrderTrackingPage.carrier') }}</p>
              <p class="text-slate-900">{{ order.shipping.carrier }}</p>
            </div>
            <div>
              <p class="text-sm font-medium text-slate-600 mb-1">{{ $t('customerOrderTrackingPage.trackingNumber') }}</p>
              ...
              >
                {{ $t('customerOrderTrackingPage.trackOn') }} {{ order.shipping.carrier }} →
              </a>
            </div>
            <div>
              <p class="text-sm font-medium text-slate-600 mb-1">{{ $t('customerOrderTrackingPage.estimatedDelivery') }}</p>
              <p class="text-slate-900">{{ order.shipping.estimatedDelivery }}</p>
            </div>
            <div>
              <p class="text-sm font-medium text-slate-600 mb-1">{{ $t('customerOrderTrackingPage.deliveryAddress') }}</p>
        ...
        <!-- Order Items -->
        <div class="bg-white rounded-lg border border-slate-200 p-6">
          <h2 class="text-lg font-semibold text-slate-900 mb-4">{{ $t('customerOrderTrackingPage.orderItems') }}</h2>
          <div class="space-y-4">
            <div
            ...
            >
              ...
              <div class="flex-1">
                ...
                <p class="text-sm text-slate-600">{{ $t('customerOrderTrackingPage.quantity') }}: {{ item.quantity }}</p>
                ...
                <div v-if="item.canReview" class="mt-3">
                  ...
                  >
                    {{ $t('customerOrderTrackingPage.writeReview') }}
                  </button>
                </div>
              </div>
            </div>
        ...
        <!-- Order Summary -->
        <div class="bg-white rounded-lg border border-slate-200 p-6">
          <h2 class="text-lg font-semibold text-slate-900 mb-4">{{ $t('customerOrderTrackingPage.orderSummary') }}</h2>
          <div class="space-y-2">
            <div class="flex justify-between text-sm">
              <span class="text-slate-600">{{ $t('customerOrderTrackingPage.subtotal') }}</span>
              <span class="text-slate-900">{{ formatPrice(order.subtotal) }}</span>
            </div>
            <div class="flex justify-between text-sm">
              <span class="text-slate-600">{{ $t('customerOrderTrackingPage.shippingCost') }}</span>
              <span class="text-slate-900">{{ formatPrice(order.shippingCost) }}</span>
            </div>
            <div class="flex justify-between text-sm">
              <span class="text-slate-600">{{ $t('customerOrderTrackingPage.tax') }}</span>
            ...
            <div class="border-t border-slate-200 pt-2 flex justify-between font-semibold">
              <span class="text-slate-900">{{ $t('customerOrderTrackingPage.totalAmount') }}</span>
...
const breadcrumbItems = computed(() => [
  ...
  { label: t('customerOrdersPage.breadcrumbOrders'), to: '/konto/bestellungen' },
  { label: t('customerOrderTrackingPage.breadcrumbOrder') + orderId.value, to: null }
])

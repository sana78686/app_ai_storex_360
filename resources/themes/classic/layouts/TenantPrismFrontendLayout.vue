...
<router-link
  ...
  class="relative flex h-10 items-center gap-2 rounded-full bg-black px-2 sm:px-3 text-xs font-semibold text-white hover:bg-black-dark touch-manipulation min-w-[44px]"
>
...
import { paymentMethods, shippingCarriers } from '@theme-classic/config/paymentShipping'

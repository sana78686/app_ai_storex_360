    ...
    <div class="mx-auto grid max-w-7xl gap-8 px-4 py-16 md:grid-cols-2 md:py-20">
      <div class="flex flex-col justify-center space-y-6 text-white">
        ...
        <router-link
          ...
          class="inline-flex w-fit items-center justify-center rounded-full bg-black px-8 py-3 text-sm font-semibold text-white transition hover:bg-black-dark"
        >
          {{ $t('common.buyNow')}}
        </router-link>
      </div>
...
// import TenantEinfacshopFrontendLayout from '@theme-classic/layouts/TenantEinfacshopFrontendLayout.vue'
import ProductCarousel from '@theme-classic/component/ProductCarousel.vue'

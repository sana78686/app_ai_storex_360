...
// import ReviewModal from '@theme-classic/component/ReviewModal.vue'
...
import { useNotificationPreferencesStore } from '@theme-classic/stores/notificationPreferencesStore'
...
const buyAgain = (order) => {
  ...
  const { useCartStore } = require('@theme-classic/stores/cartStore')

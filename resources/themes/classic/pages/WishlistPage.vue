...
// import Breadcrumb from '@theme-classic/components/Breadcrumb.vue'
...
const breadcrumbItems = computed(() => {
  // Check if we're in customer layout (route starts with /konto)
  if (route.path.startsWith('/konto')) {
    return [
      { label: 'Startseite', to: '/' },
      { label: 'Mein Konto', to: '/konto' },
      { label: 'Wunschliste', to: null }
    ]
  }
  return [
    { label: 'Startseite', to: '/' },
